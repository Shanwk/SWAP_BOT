# Pancakeswap(V2)_uniswap(V2)-bot
The  bot for Pancakeswap(V2) (BSC)

Pancakeswap bot that purchases the specified token when liquidity is added.
...
- Run script `npm start` or `node main.js`
